...
const EXPANDED_REFERENCE_FIELDS = {
  ...
  create_issue: { projectMilestoneId: 'milestone', cycleId: 'cycle', labelIds: 'labels', subscriberIds: 'subscribers', delegateId: 'delegate' },
  update_issue: { teamId: 'team', addedLabelIds: 'addLabels', removedLabelIds: 'removeLabels', projectMilestoneId: 'milestone', cycleId: 'cycle', labelIds: 'labels', subscriberIds: 'subscribers', delegateId: 'delegate', snoozedById: 'snoozedBy' },
