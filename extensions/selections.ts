...
export const PAGE_INFO = `pageInfo { hasNextPage hasPreviousPage startCursor endCursor }`;
...
export const PROJECT_DETAIL_SELECTION = `${PROJECT_BASE_SELECTION} content`;
...
`;
export const TEAM_SELECTION = `id key name description color icon private createdAt updatedAt`;
export const USER_SELECTION = `id name displayName email active admin guest isAssignable createdAt updatedAt url`;
